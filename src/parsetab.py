...
del _lr_goto_items
_lr_productions = [
  ("S' -> gab","S'",1,None,None,None),
  ('gab -> programa','gab',1,'p_gab','compiler_parser.py',8),
  ('programa -> ABRE_CHAVES declaracoes FECHA_CHAVES','programa',3,'p_programa','compiler_parser.py',21),
  ('declaracoes -> declaracoes funcao','declaracoes',2,'p_declaracoes','compiler_parser.py',27),
  ('declaracoes -> declaracoes listaAfirm','declaracoes',2,'p_declaracoes','compiler_parser.py',28),
  ('declaracoes -> empty','declaracoes',1,'p_declaracoes','compiler_parser.py',29),
  ('declaracoes_sem_func -> declaracoes_sem_func listaAfirm','declaracoes_sem_func',2,'p_declaracoesSemFunc','compiler_parser.py',43),
  ('declaracoes_sem_func -> empty','declaracoes_sem_func',1,'p_declaracoesSemFunc','compiler_parser.py',44),
  ('declaracoes_para_func -> declaracoes_para_func listaAfirmFunc','declaracoes_para_func',2,'p_declaroesParaFunc','compiler_parser.py',58),
  ('declaracoes_para_func -> empty','declaracoes_para_func',1,'p_declaroesParaFunc','compiler_parser.py',59),
  ('funcao -> FUNCAO ID ABRE_PAREN listaVar FECHA_PAREN ABRE_CHAVES declaracoes_para_func FECHA_CHAVES','funcao',8,'p_funcao','compiler_parser.py',73),
  ('chama -> ABRE_PAREN listaVar FECHA_PAREN','chama',3,'p_chama','compiler_parser.py',79),
  ('listaVar -> ID','listaVar',1,'p_listaVar_single','compiler_parser.py',85),
  ('listaVar -> empty','listaVar',1,'p_listaVar_single','compiler_parser.py',86),
  ('listaVar -> ID VIRG listaVar','listaVar',3,'p_listaVar_list','compiler_parser.py',92),
  ('listaAfirm -> listaAfirm afirmacao','listaAfirm',2,'p_listaAfirm','compiler_parser.py',98),
  ('listaAfirm -> empty','listaAfirm',1,'p_listaAfirm','compiler_parser.py',99),
  ('listaAfirmFunc -> listaAfirmFunc afirmacaoFunc','listaAfirmFunc',2,'p_listaAfirmFun','compiler_parser.py',113),
  ('listaAfirmFunc -> empty','listaAfirmFunc',1,'p_listaAfirmFun','compiler_parser.py',114),
  ('afirmacao -> enquanto','afirmacao',1,'p_afirmacao','compiler_parser.py',128),
  ('afirmacao -> caso','afirmacao',1,'p_afirmacao','compiler_parser.py',129),
  ('afirmacao -> imprimir','afirmacao',1,'p_afirmacao','compiler_parser.py',130),
  ('afirmacaoFunc -> afirmacao','afirmacaoFunc',1,'p_afirmacaoFunc','compiler_parser.py',136),
  ('afirmacaoFunc -> retornar','afirmacaoFunc',1,'p_afirmacaoFunc','compiler_parser.py',137),
  ('afirmacao -> ID chama PONTO_VIRG','afirmacao',3,'p_afirmacao_chama','compiler_parser.py',143),
  ('afirmacao -> ID atribui PONTO_VIRG','afirmacao',3,'p_afirmacao_atribui','compiler_parser.py',149),
  ('atribui -> ATRI ladoDir','atribui',2,'p_atribui','compiler_parser.py',155),
  ('atribui -> ATRI scan','atribui',2,'p_atribui','compiler_parser.py',156),
  ('scan -> SCAN ABRE_PAREN FECHA_PAREN','scan',3,'p_scan','compiler_parser.py',162),
  ('imprimir -> IMPRIMIR ABRE_PAREN ladoDir FECHA_PAREN PONTO_VIRG','imprimir',5,'p_imprimir','compiler_parser.py',168),
  ('ladoDir -> termo ADI termo','ladoDir',3,'p_ladoDir','compiler_parser.py',174),
  ('ladoDir -> termo SUB termo','ladoDir',3,'p_ladoDir','compiler_parser.py',175),
  ('ladoDir -> termo','ladoDir',1,'p_ladoDir','compiler_parser.py',176),
  ('retornar -> RETORNAR ABRE_PAREN ladoDir FECHA_PAREN PONTO_VIRG','retornar',5,'p_retornar','compiler_parser.py',185),
  ('termo -> fator','termo',1,'p_termo','compiler_parser.py',191),
  ('termo -> fator MULT fator','termo',3,'p_termo','compiler_parser.py',192),
  ('termo -> fator DIV fator','termo',3,'p_termo','compiler_parser.py',193),
  ('fator -> ADI NUMERO','fator',2,'p_fator_num','compiler_parser.py',202),
  ('fator -> SUB NUMERO','fator',2,'p_fator_num','compiler_parser.py',203),
  ('fator -> NUMERO','fator',1,'p_fator_num','compiler_parser.py',204),
  ('fator -> ADI ID','fator',2,'p_fato_id','compiler_parser.py',213),
  ('fator -> SUB ID','fator',2,'p_fato_id','compiler_parser.py',214),
  ('fator -> ID','fator',1,'p_fato_id','compiler_parser.py',215),
  ('fator -> ABRE_PAREN ladoDir FECHA_PAREN PONTO_VIRG','fator',4,'p_fator_ladoDir','compiler_parser.py',224),
  ('fator -> ID chama','fator',2,'p_fator_chama','compiler_parser.py',230),
  ('enquanto -> ENQUANTO expressao ABRE_CHAVES declaracoes_sem_func FECHA_CHAVES','enquanto',5,'p_enquanto','compiler_parser.py',236),
  ('caso -> CASO expressao ABRE_CHAVES declaracoes_sem_func FECHA_CHAVES','caso',5,'p_caso','compiler_parser.py',242),
  ('caso -> CASO expressao ABRE_CHAVES declaracoes_sem_func FECHA_CHAVES SENAO ABRE_CHAVES declaracoes_sem_func FECHA_CHAVES','caso',9,'p_caso_senao','compiler_parser.py',249),
  ('expressao -> ABRE_PAREN ID BIGGER ladoDir FECHA_PAREN','expressao',5,'p_expressao','compiler_parser.py',255),
  ('expressao -> ABRE_PAREN ID LESS ladoDir FECHA_PAREN','expressao',5,'p_expressao','compiler_parser.py',256),
  ('expressao -> ABRE_PAREN ID EQUALS ladoDir FECHA_PAREN','expressao',5,'p_expressao','compiler_parser.py',257),
  ('expressao -> ABRE_PAREN ID DIFER ladoDir FECHA_PAREN','expressao',5,'p_expressao','compiler_parser.py',258),
  ('empty -> <empty>','empty',0,'p_empty','compiler_parser.py',267),
]
